        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="sm:col-span-2">
            <div className="text-2xl sm:text-3xl font-bold mb-4">
              <span className="text-yellow-400">World</span> Group of Companies
            </div>
            <p className="text-gray-300 mb-6 max-w-md text-sm sm:text-base leading-relaxed">
              Leading the way across healthcare, pharmaceuticals, and mining sectors with innovation,
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a href="#home" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 text-sm sm:text-base">
                  Home
                </a>
              </li>
              <li>
                <a href="#companies" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 text-sm sm:text-base">
                  Our Companies
                </a>
              </li>
              <li>
                <a href="#leadership" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 text-sm sm:text-base">
                  Leadership
                </a>
              </li>
              <li>
                <a href="#about" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 text-sm sm:text-base">
                  About Us
                </a>
              </li>
              <li>
                <a href="#contact" className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 text-sm sm:text-base">
                  Contact
                </a>
              </li>
            </ul>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs sm:text-sm">info@worldgroup.com</p>
                </div>
              </div>
            </div>
          </div>
